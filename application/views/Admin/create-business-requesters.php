                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card card-box">
                                    <div class="card-body" id="bar-parent">
                                        <form action="<?php echo base_url().'admin/Bussines_requesters/create';?>" method="post" id="form_sample_1" class="form-horizontal">
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="username" id="username" data-required="1" placeholder="Enter Username" class="form-control input-height">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="email" name="email" id="email" data-required="1" placeholder="Enter Email" class="form-control input-height">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-control input-height" name="site" id="site">
