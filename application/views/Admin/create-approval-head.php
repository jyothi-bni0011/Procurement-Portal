                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Create Approval Head</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
								<li><a class="parent-item" href="approval-head.php">Approval Heads</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Create Approval Head</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
