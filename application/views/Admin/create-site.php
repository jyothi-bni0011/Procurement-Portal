                    ...
                    <div class="row">
                      ...
                      <option value="">Select Region</option>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
								<input type="text" name="" data-required="1" placeholder="Enter Site Name" class="form-control input-height">
                                                     </div>
                                            </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
								<input type="text" name="" data-required="1" placeholder="Enter Site Owner" class="form-control input-height">
                                                     </div>
                                            </div>
